...
void gpioExpanderGnssReset()
{
    //    if (online.gpioExpanderSwitches == true)
    {
        ...
        //myGnss.reset(); // Use software reset instead of hardware reset for LG290P to avoid killing the I2C bus
    }
}
...
void beginGpioExpanderSwitches()
{
    ...
    if (gpioExpanderSwitches->begin(0x21) == false)
    {
        ...
        //We can't do anything if the LG290P is hogging the I2C bus.
        delay(500);
        ESP.restart();
