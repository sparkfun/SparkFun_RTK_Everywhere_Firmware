...
const char *firmwareURL_11_4_1 = "/imu/im19/20260522185649_VH2_B2.2_A11.4.1_131b44ecee0bdad5670c7.enc";
const char *firmwareURL_11_1 = "/imu/im19/20260302210315_VH2_B2.2_A11.1_6bf04becee0bda310e65d.enc";
const char *firmwareURL_6_1 = "/imu/im19/20230419111130_VH2_B2.2_A6.1_2eea4d4c024538bf5ed52.enc";
...
void setup()
{
    ...
    systemPrintln("1) Load IM19 firmware v11.4.1");
    systemPrintln("2) Load IM19 firmware v11.1");
    systemPrintln("3) Load IM19 firmware v6.1");
}
...
void loop()
{
    if (Serial.available())
    {
        ...
        else if ((incoming == '1') || (incoming == '2') || (incoming == '3'))
        {
            const char *firmwareURL = firmwareURL_6_1;
            if (incoming == '1')
                firmwareURL = firmwareURL_11_4_1;
            else if (incoming == '2')
                firmwareURL = firmwareURL_11_1;

            systemPrint("Loading IM19 firmware ");
            if (incoming == '1')
                systemPrintln("v11.4.1");
            else if (incoming == '2')
                systemPrintln("v11.1");
            else
                systemPrintln("v6.1");
