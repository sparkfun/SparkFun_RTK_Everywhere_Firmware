...
const GET_PAGE_HANDLER webServerPages[] = {
    ...
    // Generated by Firmware/Tools/generate_settings_defaults_js.py from settings.h
    WEB_PAGE(20, "/src/settingsDefaults.js", text_javascript, settings_defaults_js),

    // Style sheets
    WEB_PAGE(21, "/src/bootstrap.min.css", text_css, bootstrap_min_css),
    WEB_PAGE(22, "/src/style.css", text_css, style_css),

    // File pages
    PAGE_HANDLER(23, "/listfiles", HTTP_GET, text_plain, webServerHandlerFileList),
    PAGE_HANDLER(24, "/file", HTTP_GET, text_plain, webServerHandlerFileManager),
