...
const RTK_Settings_Entry rtkSettingsEntries[] = {
    ...
    { & settings.enableSD, "enableSD", _bool, 0, false, true },
    { & settings.maxLogTime_minutes, "maxLogTime", _int, 0, false, true },
    { & settings.maxLogLength_minutes, "maxLogLength", _int, 0, false, true },
    { & settings.observationSeconds, "observationSeconds", _int, 0, true, true },
    { & settings.observationPositionAccuracy, "observationPositionAccuracy", _float, point2float, true, true },
    { & settings.fixedBase, "fixedBase", _bool, 0, true, false },
    { & settings.fixedBaseCoordinateType, "fixedBaseCoordinateType", _bool, 0, true, false },
    { & settings.fixedEcefX, "fixedEcefX", _double, point3float, true, true },
    { & settings.fixedEcefY, "fixedEcefY", _double, point3float, true, true },
    { & settings.fixedEcefZ, "fixedEcefZ", _double, point3float, true, true },
    { & settings.fixedLat, "fixedLat", _double, point9float, true, true },
    { & settings.fixedLong, "fixedLong", _double, point9float, true, true },
    { & settings.fixedAltitude, "fixedAltitude", _double, point4float, true, true },
    { & settings.dataPortBaud, "dataPortBaud", _uint32_t, 0, true, true },
    { & settings.radioPortBaud, "radioPortBaud", _uint32_t, 0, true, true },
    { & settings.zedSurveyInStartingAccuracy, "zedSurveyInStartingAccuracy", _float, point1float, true, true },
    { & settings.measurementRate, "measurementRate", _uint16_t, 0, true, false },
    { & settings.navigationRate, "navigationRate", _uint16_t, 0, true, false },
    { & settings.debugGnss, "debugGnss", _bool, 0, false, true },
    { & settings.enableHeapReport, "enableHeapReport", _bool, 0, false, true },
    { & settings.enableTaskReports, "enableTaskReports", _bool, 0, false, true },
    { & settings.dataPortChannel, "dataPortChannel", _muxConnectionType_e, 0, false, true },
    { & settings.spiFrequency, "spiFrequency", _uint16_t, 0, false, true },
    { & settings.enableLogging, "enableLogging", _bool, 0, false, true },
    { & settings.enableARPLogging, "enableARPLogging", _bool, 0, false, true },
    { & settings.ARPLoggingInterval_s, "ARPLoggingInterval", _uint16_t, 0, false, true },
    { & settings.sppRxQueueSize, "sppRxQueueSize", _uint16_t, 0, false, true },
    { & settings.sppTxQueueSize, "sppTxQueueSize", _uint16_t, 0, false, true },
    { & settings.dynamicModel, "dynamicModel", _uint8_t, 0, true, true },
    { & settings.lastState, "lastState", _SystemState, 0, true, false },
    { & settings.enableResetDisplay, "enableResetDisplay", _bool, 0, false, true },
    { & settings.resetCount, "resetCount", _int, 0, false, true },
    { & settings.enableExternalPulse, "enableExternalPulse", _bool, 0, true, true },
    { & settings.externalPulseTimeBetweenPulse_us, "externalPulseTimeBetweenPulse", _uint64_t, 0, true, true },
    { & settings.externalPulseLength_us, "externalPulseLength", _uint64_t, 0, true, true },
    { & settings.externalPulsePolarity, "externalPulsePolarity", _pulseEdgeType_e, 0, true, true },
    { & settings.enableExternalHardwareEventLogging, "enableExternalHardwareEventLogging", _bool, 0, true, true },
    { & settings.enableUART2UBXIn, "enableUART2UBXIn", _bool, 0, false, true },

    { & settings.ubxMessageRates[0], "ubxMessageRate_", _ubxMessageRates, MAX_UBX_MSG, true, false },

    { & settings.ubxConstellations[0], "ubxConstellation_", _ubxConstellations, MAX_CONSTELLATIONS, true, true },

    { & settings.profileName, "profileName", _charArray, sizeof(settings.profileName), false, false },

    { & settings.serialTimeoutGNSS, "serialTimeoutGNSS", _int16_t, 0, false, true },

    { & settings.pointPerfectDeviceProfileToken, "pointPerfectDeviceProfileToken", _charArray, sizeof(settings.pointPerfectDeviceProfileToken), false, true },
    { & settings.enablePointPerfectCorrections, "enablePointPerfectCorrections", _bool, 0, false, true },
    { & settings.autoKeyRenewal, "autoKeyRenewal", _bool, 0, false, true },
    { & settings.pointPerfectClientID, "pointPerfectClientID", _charArray, sizeof(settings.pointPerfectClientID), false, true },
    { & settings.pointPerfectBrokerHost, "pointPerfectBrokerHost", _charArray, sizeof(settings.pointPerfectBrokerHost), false, true },
    { & settings.pointPerfectKeyDistributionTopic, "pointPerfectKeyDistributionTopic", _charArray, sizeof(settings.pointPerfectKeyDistributionTopic), false, true },

    { & settings.pointPerfectCurrentKey, "pointPerfectCurrentKey", _charArray, sizeof(settings.pointPerfectCurrentKey), false, true },
    { & settings.pointPerfectCurrentKeyDuration, "pointPerfectCurrentKeyDuration", _uint64_t, 0, false, true },
    { & settings.pointPerfectCurrentKeyStart, "pointPerfectCurrentKeyStart", _uint64_t, 0, false, true },

    { & settings.pointPerfectNextKey, "pointPerfectNextKey", _charArray, sizeof(settings.pointPerfectNextKey), false, true },
    { & settings.pointPerfectNextKeyDuration, "pointPerfectNextKeyDuration", _uint64_t, 0, false, true },
    { & settings.pointPerfectNextKeyStart, "pointPerfectNextKeyStart", _uint64_t, 0, false, true },

    { & settings.lastKeyAttempt, "lastKeyAttempt", _uint64_t, 0, false, true },
    { & settings.updateGNSSSettings, "updateGNSSSettings", _bool, 0, false, true },

    { & settings.debugPpCertificate, "debugPpCertificate", _bool, 0, false, false },

    { & settings.timeZoneHours, "timeZoneHours", _int8_t, 0, false, true },
    { & settings.timeZoneMinutes, "timeZoneMinutes", _int8_t, 0, false, true },
    { & settings.timeZoneSeconds, "timeZoneSeconds", _int8_t, 0, false, true },

    { & settings.enablePrintState, "enablePrintState", _bool, 0, false, true },
    { & settings.enablePrintPosition, "enablePrintPosition", _bool, 0, false, true },
    { & settings.enablePrintIdleTime, "enablePrintIdleTime", _bool, 0, false, true },
    { & settings.enablePrintBatteryMessages, "enablePrintBatteryMessages", _bool, 0, false, true },
    { & settings.enablePrintRoverAccuracy, "enablePrintRoverAccuracy", _bool, 0, false, true },
    { & settings.enablePrintBadMessages, "enablePrintBadMessages", _bool, 0, false, true },
    { & settings.enablePrintLogFileMessages, "enablePrintLogFileMessages", _bool, 0, false, true },
    { & settings.enablePrintLogFileStatus, "enablePrintLogFileStatus", _bool, 0, false, true },
    { & settings.enablePrintRingBufferOffsets, "enablePrintRingBufferOffsets", _bool, 0, false, true },
    { & settings.enablePrintStates, "enablePrintStates", _bool, 0, false, true },
    { & settings.enablePrintDuplicateStates, "enablePrintDuplicateStates", _bool, 0, false, true },
    { & settings.enablePrintRtcSync, "enablePrintRtcSync", _bool, 0, false, true },

    { & settings.espnowPeers[0][0], "espnowPeer_", _espnowPeers, ESPNOW_MAX_PEERS, false, true },

    { & settings.espnowPeerCount, "espnowPeerCount", _uint8_t, 0, false, true },
    { & settings.enableRtcmMessageChecking, "enableRtcmMessageChecking", _bool, 0, false, false },
    { & settings.bluetoothRadioType, "bluetoothRadioType", _BluetoothRadioType_e, 0, false, true },
    { & settings.runLogTest, "runLogTest", _bool, 0, false, true }, // Not stored in NVM
    { & settings.espnowBroadcast, "espnowBroadcast", _bool, 0, false, true },
    { & settings.antennaHeight, "antennaHeight", _int16_t, 0, false, true },
    { & settings.antennaReferencePoint, "antennaReferencePoint", _float, point2float, false, true },
    { & settings.echoUserInput, "echoUserInput", _bool, 0, false, true },
    { & settings.uartReceiveBufferSize, "uartReceiveBufferSize", _int, 0, false, true },
    { & settings.gnssHandlerBufferSize, "gnssHandlerBufferSize", _int, 0, false, true },

    { & settings.enablePrintBufferOverrun, "enablePrintBufferOverrun", _bool, 0, false, true },
    { & settings.enablePrintSDBuffers, "enablePrintSDBuffers", _bool, 0, false, true },
    { & settings.periodicDisplay, "periodicDisplay", _PeriodicDisplay_t, 0, false, true },
    { & settings.periodicDisplayInterval, "periodicDisplayInterval", _uint32_t, 0, false, true },

    { & settings.rebootSeconds, "rebootSeconds", _uint32_t, 0, false, true },
    { & settings.forceResetOnSDFail, "forceResetOnSDFail", _bool, 0, false, true },

    { & settings.minElev, "minElev", _uint8_t, 0, true, true },

    { & settings.ubxMessageRatesBase[0], "ubxMessageRateBase_", _ubxMessageRateBase, MAX_UBX_MSG_RTCM, true, false },

    { & settings.coordinateInputType, "coordinateInputType", _CoordinateInputType, 0, false, true },
    { & settings.lbandFixTimeout_seconds, "lbandFixTimeout", _uint16_t, 0, false, true },
    { & settings.minCNO_F9P, "minCNOF9P", _int16_t, 0, true, true },
    { & settings.serialGNSSRxFullThreshold, "serialGNSSRxFullThreshold", _uint16_t, 0, false, true },
    { & settings.btReadTaskPriority, "btReadTaskPriority", _uint8_t, 0, false, true },
    { & settings.gnssReadTaskPriority, "gnssReadTaskPriority", _uint8_t, 0, false, true },
    { & settings.handleGnssDataTaskPriority, "handleGnssDataTaskPriority", _uint8_t, 0, false, true },
    { & settings.btReadTaskCore, "btReadTaskCore", _uint8_t, 0, false, true },
    { & settings.gnssReadTaskCore, "gnssReadTaskCore", _uint8_t, 0, false, true },
    { & settings.handleGnssDataTaskCore, "handleGnssDataTaskCore", _uint8_t, 0, false, true },
    { & settings.gnssUartInterruptsCore, "gnssUartInterruptsCore", _uint8_t, 0, false, true },
    { & settings.bluetoothInterruptsCore, "bluetoothInterruptsCore", _uint8_t, 0, false, true },
    { & settings.i2cInterruptsCore, "i2cInterruptsCore", _uint8_t, 0, false, true },
    { & settings.shutdownNoChargeTimeout_s, "shutdownNoChargeTimeout", _uint32_t, 0, false, true },
    { & settings.disableSetupButton, "disableSetupButton", _bool, 0, false, true },

    { & settings.enablePrintEthernetDiag, "enablePrintEthernetDiag", _bool, 0, false, true },
    { & settings.ethernetDHCP, "ethernetDHCP", _bool, 0, false, true },
    { & settings.ethernetIP, "ethernetIP", _IPString, 0, false, true },
    { & settings.ethernetDNS, "ethernetDNS", _IPString, 0, false, true },
    { & settings.ethernetGateway, "ethernetGateway", _IPString, 0, false, true },
    { & settings.ethernetSubnet, "ethernetSubnet", _IPString, 0, false, true },
    { & settings.httpPort, "httpPort", _uint16_t, 0, false, true },

    { & settings.debugWifiState, "debugWifiState", _bool, 0, false, true },
    { & settings.wifiConfigOverAP, "wifiConfigOverAP", _bool, 0, false, false }, // TODO: check drop downs

    { & settings.wifiNetworks, "wifiNetwork_", _wifiNetwork, MAX_WIFI_NETWORKS, false, true },

    { & settings.defaultNetworkType, "defaultNetworkType", _uint8_t, 0, false, true },
    { & settings.debugNetworkLayer, "debugNetworkLayer", _bool, 0, false, true },
    { & settings.enableNetworkFailover, "enableNetworkFailover", _bool, 0, false, true },
    { & settings.printNetworkStatus, "printNetworkStatus", _bool, 0, false, true },

    { & settings.mdnsEnable, "mdnsEnable", _bool, 0, false, true },

    { & settings.debugMqttClientData, "debugMqttClientData", _bool, 0, false, true },
    { & settings.debugMqttClientState, "debugMqttClientState", _bool, 0, false, true },

    { & settings.debugNtp, "debugNtp", _bool, 0, false, true },
    { & settings.ethernetNtpPort, "ethernetNtpPort", _uint16_t, 0, false, true },
    { & settings.enableNTPFile, "enableNTPFile", _bool, 0, false, true },
    { & settings.ntpPollExponent, "ntpPollExponent", _uint8_t, 0, false, true },
    { & settings.ntpPrecision, "ntpPrecision", _int8_t, 0, false, true },
    { & settings.ntpRootDelay, "ntpRootDelay", _uint32_t, 0, false, true },
    { & settings.ntpRootDispersion, "ntpRootDispersion", _uint32_t, 0, false, true },
    { & settings.ntpReferenceId, "ntpReferenceId", _charArray, sizeof(settings.ntpReferenceId), false, true },

    { & settings.debugNtripClientRtcm, "debugNtripClientRtcm", _bool, 0, false, true },
    { & settings.debugNtripClientState, "debugNtripClientState", _bool, 0, false, true },
    { & settings.enableNtripClient, "enableNtripClient", _bool, 0, false, true },
    { & settings.ntripClient_CasterHost, "ntripClientCasterHost", _charArray, sizeof(settings.ntripClient_CasterHost), false, true },
    { & settings.ntripClient_CasterPort, "ntripClientCasterPort", _uint16_t, 0, false, true },
    { & settings.ntripClient_CasterUser, "ntripClientCasterUser", _charArray, sizeof(settings.ntripClient_CasterUser), false, true },
    { & settings.ntripClient_CasterUserPW, "ntripClientCasterUserPW", _charArray, sizeof(settings.ntripClient_CasterUserPW), false, true },
    { & settings.ntripClient_MountPoint, "ntripClientMountPoint", _charArray, sizeof(settings.ntripClient_MountPoint), false, true },
    { & settings.ntripClient_MountPointPW, "ntripClientMountPointPW", _charArray, sizeof(settings.ntripClient_MountPointPW), false, true },
    { & settings.ntripClient_TransmitGGA, "ntripClientTransmitGGA", _bool, 0, false, true },

    { & settings.debugNtripServerRtcm, "debugNtripServerRtcm", _bool, 0, false, true },
    { & settings.debugNtripServerState, "debugNtripServerState", _bool, 0, false, true },
    { & settings.enableNtripServer, "enableNtripServer", _bool, 0, false, true },

    { & settings.ntripServer_CasterHost[0], "ntripServerCasterHost_", _ntripServerCasterHost, NTRIP_SERVER_MAX, false, true },
    { & settings.ntripServer_CasterPort[0], "ntripServerCasterPort_", _ntripServerCasterPort, NTRIP_SERVER_MAX, false, true },
    { & settings.ntripServer_CasterUser[0], "ntripServerCasterUser_", _ntripServerCasterUser, NTRIP_SERVER_MAX, false, true },
    { & settings.ntripServer_CasterUserPW[0], "ntripServerCasterUserPW_", _ntripServerCasterUserPW, NTRIP_SERVER_MAX, false, true },
    { & settings.ntripServer_MountPoint[0], "ntripServerMountPoint_", _ntripServerMountPoint, NTRIP_SERVER_MAX, false, true },
    { & settings.ntripServer_MountPointPW[0], "ntripServerMountPointPW_", _ntripServerMountPointPW, NTRIP_SERVER_MAX, false, true },

    { & settings.debugPvtClient, "debugPvtClient", _bool, 0, false, true },
    { & settings.enablePvtClient, "enablePvtClient", _bool, 0, false, true },
    { & settings.pvtClientPort, "pvtClientPort", _uint16_t, 0, false, true },
    { & settings.pvtClientHost, "pvtClientHost", _charArray, sizeof(settings.pvtClientHost), false, true },

    { & settings.debugPvtServer, "debugPvtServer", _bool, 0, false, true },
    { & settings.enablePvtServer, "enablePvtServer", _bool, 0, false, true },
    { & settings.pvtServerPort, "pvtServerPort", _uint16_t, 0, false, true },

    { & settings.debugPvtUdpServer, "debugPvtUdpServer", _bool, 0, false, true },
    { & settings.enablePvtUdpServer, "enablePvtUdpServer", _bool, 0, false, true },
    { & settings.pvtUdpServerPort, "pvtUdpServerPort", _uint16_t, 0, false, true },

    { & settings.um980MessageRatesNMEA, "um980MessageRatesNMEA_", _um980MessageRatesNMEA, MAX_UM980_NMEA_MSG, false, false },
    { & settings.um980MessageRatesRTCMRover, "um980MessageRatesRTCMRover_", _um980MessageRatesRTCMRover, MAX_UM980_RTCM_MSG, false, false },
    { & settings.um980MessageRatesRTCMBase, "um980MessageRatesRTCMBase_", _um980MessageRatesRTCMBase, MAX_UM980_RTCM_MSG, false, false },
    { & settings.um980Constellations, "um980Constellations_", _um980Constellations, MAX_UM980_CONSTELLATIONS, false, true },

    { & settings.minCNO_um980, "minCNOum980", _int16_t, 0, false, true },
    { & settings.enableTiltCompensation, "enableTiltCompensation", _bool, 0, false, true },
    { & settings.tiltPoleLength, "tiltPoleLength", _float, point2float, false, true },
    { & settings.enableImuDebug, "enableImuDebug", _bool, 0, false, true },

    { & settings.debugFirmwareUpdate, "debugFirmwareUpdate", _bool, 0, false, true },
    { & settings.enableAutoFirmwareUpdate, "enableAutoFirmwareUpdate", _bool, 0, false, true },
    { & settings.autoFirmwareCheckMinutes, "autoFirmwareCheckMinutes", _uint32_t, 0, false, true },

    { & settings.debugCorrections, "debugCorrections", _bool, 0, false, true },
    { & settings.enableCaptivePortal, "enableCaptivePortal", _bool, 0, false, true },

    { & settings.printBootTimes, "printBootTimes", _bool, 0, false, true },

    { & settings.printPartitionTable, "printPartitionTable", _bool, 0, false, true },

    { & settings.measurementScale, "measurementScale", _uint8_t, 0, false, true },

    { & settings.debugWiFiConfig, "debugWiFiConfig", _bool, 0, false, true },
    { & settings.enablePsram, "enablePsram", _bool, 0, false, true },
    { & settings.printTaskStartStop, "printTaskStartStop", _bool, 0, false, true },
    { & settings.psramMallocLevel, "psramMallocLevel", _uint16_t, 0, false, true },
    { & settings.um980SurveyInStartingAccuracy, "um980SurveyInStartingAccuracy", _float, point1float, false, true },
    { & settings.enableBeeper, "enableBeeper", _bool, 0, false, true },
    { & settings.um980MeasurementRateMs, "um980MeasurementRateMs", _uint16_t, 0, false, true },
    { & settings.enableImuCompensationDebug, "enableImuCompensationDebug", _bool, 0, false, true },

    { & settings.correctionsSourcesPriority, "correctionsSourcesPriority_", _correctionsSourcesPriority, correctionsSource::CORR_NUM, false, true },

    { & settings.correctionsSourcesLifetime_s, "correctionsSourcesLifetime", _int, 0, false, true },

    { & settings.geographicRegion, "geographicRegion", _int, 0, false, true },

    { & settings.regionalCorrectionTopics, "regionalCorrectionTopics_", _regionalCorrectionTopics, numRegionalAreas, false, true },

    { & settings.debugEspNow, "debugEspNow", _bool, 0, false, true },
    { & settings.enableEspNow, "enableEspNow", _bool, 0, false, true },
    { & settings.wifiChannel, "wifiChannel", _uint8_t, 0, false, true },
