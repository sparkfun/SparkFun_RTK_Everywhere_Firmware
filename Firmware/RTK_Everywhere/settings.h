...
//    N  e  m
//    S  t  d
//    S  t  s  Type   Qual    Name        Variable
    { 0, 1, 1, & settings.enableSD, "enableSD", _bool, 0},
    { 0, 1, 1, & settings.maxLogTime_minutes, "maxLogTime", _int, 0},
    { 0, 1, 1, & settings.maxLogLength_minutes, "maxLogLength", _int, 0,  },
    { 1, 1, 1, & settings.observationSeconds, "observationSeconds", _int, 0,  },
    { 1, 1, 1, & settings.observationPositionAccuracy, "observationPositionAccuracy", _float, point2float,  },
    { 1, 0, 1, & settings.fixedBase, "fixedBase", _bool, 0,  },
    { 1, 0, 1, & settings.fixedBaseCoordinateType, "fixedBaseCoordinateType", _bool, 0,  },
    { 1, 1, 1, & settings.fixedEcefX, "fixedEcefX", _double, point3float,  },
    { 1, 1, 1, & settings.fixedEcefY, "fixedEcefY", _double, point3float,  },
    { 1, 1, 1, & settings.fixedEcefZ, "fixedEcefZ", _double, point3float,  },
    { 1, 1, 1, & settings.fixedLat, "fixedLat", _double, point9float,  },
    { 1, 1, 1, & settings.fixedLong, "fixedLong", _double, point9float,  },
    { 1, 1, 1, & settings.fixedAltitude, "fixedAltitude", _double, point4float,  },
    { 1, 1, 1, & settings.dataPortBaud, "dataPortBaud", _uint32_t, 0,  },
    { 1, 1, 1, & settings.radioPortBaud, "radioPortBaud", _uint32_t, 0,  },
    { 1, 1, 1, & settings.surveyInStartingAccuracy, "surveyInStartingAccuracy", _float, point1float,  },
    { 1, 0, 1, & settings.measurementRateMs, "measurementRateMs", _uint16_t, 0,  },
    { 1, 0, 1, & settings.navigationRate, "navigationRate", _uint16_t, 0,  },
    { 0, 1, 1, & settings.debugGnss, "debugGnss", _bool, 0,  },
    { 0, 1, 1, & settings.enableHeapReport, "enableHeapReport", _bool, 0,  },
    { 0, 1, 1, & settings.enableTaskReports, "enableTaskReports", _bool, 0,  },
    { 0, 1, 1, & settings.dataPortChannel, "dataPortChannel", _muxConnectionType_e, 0,  },
    { 0, 1, 1, & settings.spiFrequency, "spiFrequency", _uint16_t, 0,  },
    { 0, 1, 1, & settings.enableLogging, "enableLogging", _bool, 0,  },
    { 0, 1, 1, & settings.enableARPLogging, "enableARPLogging", _bool, 0,  },
    { 0, 1, 1, & settings.ARPLoggingInterval_s, "ARPLoggingInterval", _uint16_t, 0,  },
    { 0, 1, 1, & settings.sppRxQueueSize, "sppRxQueueSize", _uint16_t, 0,  },
    { 0, 1, 1, & settings.sppTxQueueSize, "sppTxQueueSize", _uint16_t, 0,  },
    { 1, 1, 1, & settings.dynamicModel, "dynamicModel", _uint8_t, 0,  },
    { 1, 0, 1, & settings.lastState, "lastState", _SystemState, 0,  },
    { 0, 1, 1, & settings.enableResetDisplay, "enableResetDisplay", _bool, 0,  },
    { 0, 1, 1, & settings.resetCount, "resetCount", _int, 0,  },
    { 1, 1, 1, & settings.enableExternalPulse, "enableExternalPulse", _bool, 0,  },
    { 1, 1, 1, & settings.externalPulseTimeBetweenPulse_us, "externalPulseTimeBetweenPulse", _uint64_t, 0,  },
    { 1, 1, 1, & settings.externalPulseLength_us, "externalPulseLength", _uint64_t, 0,  },
    { 1, 1, 1, & settings.externalPulsePolarity, "externalPulsePolarity", _pulseEdgeType_e, 0,  },
    { 1, 1, 1, & settings.enableExternalHardwareEventLogging, "enableExternalHardwareEventLogging", _bool, 0,  },
    { 0, 1, 1, & settings.enableUART2UBXIn, "enableUART2UBXIn", _bool, 0,  },

    { 1, 0, 1, & settings.ubxMessageRates[0], "ubxMessageRate_", _ubxMessageRates, MAX_UBX_MSG,  },

    { 1, 1, 1, & settings.ubxConstellations[0], "ubxConstellation_", _ubxConstellations, MAX_CONSTELLATIONS,  },

    { 0, 0, 1, & settings.profileName, "profileName", _charArray, sizeof(settings.profileName),  },

    { 0, 1, 1, & settings.serialTimeoutGNSS, "serialTimeoutGNSS", _int16_t, 0,  },

    { 0, 1, 1, & settings.pointPerfectDeviceProfileToken, "pointPerfectDeviceProfileToken", _charArray, sizeof(settings.pointPerfectDeviceProfileToken),  },
    { 0, 1, 1, & settings.enablePointPerfectCorrections, "enablePointPerfectCorrections", _bool, 0,  },
    { 0, 1, 1, & settings.autoKeyRenewal, "autoKeyRenewal", _bool, 0,  },
    { 0, 1, 1, & settings.pointPerfectClientID, "pointPerfectClientID", _charArray, sizeof(settings.pointPerfectClientID),  },
    { 0, 1, 1, & settings.pointPerfectBrokerHost, "pointPerfectBrokerHost", _charArray, sizeof(settings.pointPerfectBrokerHost),  },
    { 0, 1, 1, & settings.pointPerfectKeyDistributionTopic, "pointPerfectKeyDistributionTopic", _charArray, sizeof(settings.pointPerfectKeyDistributionTopic),  },

    { 0, 1, 1, & settings.pointPerfectCurrentKey, "pointPerfectCurrentKey", _charArray, sizeof(settings.pointPerfectCurrentKey),  },
    { 0, 1, 1, & settings.pointPerfectCurrentKeyDuration, "pointPerfectCurrentKeyDuration", _uint64_t, 0,  },
    { 0, 1, 1, & settings.pointPerfectCurrentKeyStart, "pointPerfectCurrentKeyStart", _uint64_t, 0,  },

    { 0, 1, 1, & settings.pointPerfectNextKey, "pointPerfectNextKey", _charArray, sizeof(settings.pointPerfectNextKey),  },
    { 0, 1, 1, & settings.pointPerfectNextKeyDuration, "pointPerfectNextKeyDuration", _uint64_t, 0,  },
    { 0, 1, 1, & settings.pointPerfectNextKeyStart, "pointPerfectNextKeyStart", _uint64_t, 0,  },

    { 0, 1, 1, & settings.lastKeyAttempt, "lastKeyAttempt", _uint64_t, 0,  },
    { 0, 1, 1, & settings.updateGNSSSettings, "updateGNSSSettings", _bool, 0,  },

    { 0, 0, 1, & settings.debugPpCertificate, "debugPpCertificate", _bool, 0,  },

    { 0, 1, 1, & settings.timeZoneHours, "timeZoneHours", _int8_t, 0,  },
    { 0, 1, 1, & settings.timeZoneMinutes, "timeZoneMinutes", _int8_t, 0,  },
    { 0, 1, 1, & settings.timeZoneSeconds, "timeZoneSeconds", _int8_t, 0,  },

    { 0, 1, 1, & settings.enablePrintState, "enablePrintState", _bool, 0,  },
    { 0, 1, 1, & settings.enablePrintPosition, "enablePrintPosition", _bool, 0,  },
    { 0, 1, 1, & settings.enablePrintIdleTime, "enablePrintIdleTime", _bool, 0,  },
    { 0, 1, 1, & settings.enablePrintBatteryMessages, "enablePrintBatteryMessages", _bool, 0,  },
    { 0, 1, 1, & settings.enablePrintRoverAccuracy, "enablePrintRoverAccuracy", _bool, 0,  },
    { 0, 1, 1, & settings.enablePrintBadMessages, "enablePrintBadMessages", _bool, 0,  },
    { 0, 1, 1, & settings.enablePrintLogFileMessages, "enablePrintLogFileMessages", _bool, 0,  },
    { 0, 1, 1, & settings.enablePrintLogFileStatus, "enablePrintLogFileStatus", _bool, 0,  },
    { 0, 1, 1, & settings.enablePrintRingBufferOffsets, "enablePrintRingBufferOffsets", _bool, 0,  },
    { 0, 1, 1, & settings.enablePrintStates, "enablePrintStates", _bool, 0,  },
    { 0, 1, 1, & settings.enablePrintDuplicateStates, "enablePrintDuplicateStates", _bool, 0,  },
    { 0, 1, 1, & settings.enablePrintRtcSync, "enablePrintRtcSync", _bool, 0,  },

    { 0, 1, 1, & settings.espnowPeers[0][0], "espnowPeer_", _espnowPeers, ESPNOW_MAX_PEERS,  },

    { 0, 1, 1, & settings.espnowPeerCount, "espnowPeerCount", _uint8_t, 0,  },
    { 0, 0, 1, & settings.enableRtcmMessageChecking, "enableRtcmMessageChecking", _bool, 0,  },
    { 0, 1, 1, & settings.bluetoothRadioType, "bluetoothRadioType", _BluetoothRadioType_e, 0,  },
    { 0, 1, 1, & settings.runLogTest, "runLogTest", _bool, 0,  }, // Not stored in NVM
    { 0, 1, 1, & settings.espnowBroadcast, "espnowBroadcast", _bool, 0,  },
    { 0, 1, 1, & settings.antennaHeight, "antennaHeight", _int16_t, 0,  },
    { 0, 1, 1, & settings.antennaReferencePoint, "antennaReferencePoint", _float, point2float },
    { 0, 1, 1, & settings.echoUserInput, "echoUserInput", _bool, 0,  },
    { 0, 1, 1, & settings.uartReceiveBufferSize, "uartReceiveBufferSize", _int, 0,  },
    { 0, 1, 1, & settings.gnssHandlerBufferSize, "gnssHandlerBufferSize", _int, 0,  },

    { 0, 1, 1, & settings.enablePrintBufferOverrun, "enablePrintBufferOverrun", _bool, 0,  },
    { 0, 1, 1, & settings.enablePrintSDBuffers, "enablePrintSDBuffers", _bool, 0,  },
    { 0, 1, 1, & settings.periodicDisplay, "periodicDisplay", _PeriodicDisplay_t, 0,  },
    { 0, 1, 1, & settings.periodicDisplayInterval, "periodicDisplayInterval", _uint32_t, 0,  },

    { 0, 1, 1, & settings.rebootSeconds, "rebootSeconds", _uint32_t, 0,  },
    { 0, 1, 1, & settings.forceResetOnSDFail, "forceResetOnSDFail", _bool, 0,  },

    { 1, 1, 1, & settings.minElev, "minElev", _uint8_t, 0,  },

    { 1, 0, 1, & settings.ubxMessageRatesBase[0], "ubxMessageRateBase_", _ubxMessageRateBase, MAX_UBX_MSG_RTCM,  },

    { 0, 1, 1, & settings.coordinateInputType, "coordinateInputType", _CoordinateInputType, 0,  },
    { 0, 1, 1, & settings.lbandFixTimeout_seconds, "lbandFixTimeout", _uint16_t, 0,  },
    { 1, 0, 1, & settings.minCNO, "minCNO", _int16_t, 0,  },
    { 0, 1, 1, & settings.serialGNSSRxFullThreshold, "serialGNSSRxFullThreshold", _uint16_t, 0,  },
    { 0, 1, 1, & settings.btReadTaskPriority, "btReadTaskPriority", _uint8_t, 0,  },
    { 0, 1, 1, & settings.gnssReadTaskPriority, "gnssReadTaskPriority", _uint8_t, 0,  },
    { 0, 1, 1, & settings.handleGnssDataTaskPriority, "handleGnssDataTaskPriority", _uint8_t, 0,  },
    { 0, 1, 1, & settings.btReadTaskCore, "btReadTaskCore", _uint8_t, 0,  },
    { 0, 1, 1, & settings.gnssReadTaskCore, "gnssReadTaskCore", _uint8_t, 0,  },
    { 0, 1, 1, & settings.handleGnssDataTaskCore, "handleGnssDataTaskCore", _uint8_t, 0,  },
    { 0, 1, 1, & settings.gnssUartInterruptsCore, "gnssUartInterruptsCore", _uint8_t, 0,  },
    { 0, 1, 1, & settings.bluetoothInterruptsCore, "bluetoothInterruptsCore", _uint8_t, 0,  },
    { 0, 1, 1, & settings.i2cInterruptsCore, "i2cInterruptsCore", _uint8_t, 0,  },
    { 0, 1, 1, & settings.shutdownNoChargeTimeout_s, "shutdownNoChargeTimeout", _uint32_t, 0,  },
    { 0, 1, 1, & settings.disableSetupButton, "disableSetupButton", _bool, 0,  },

    { 0, 1, 1, & settings.enablePrintEthernetDiag, "enablePrintEthernetDiag", _bool, 0,  },
    { 0, 1, 1, & settings.ethernetDHCP, "ethernetDHCP", _bool, 0,  },
    { 0, 1, 1, & settings.ethernetIP, "ethernetIP", _IPString, 0,  },
    { 0, 1, 1, & settings.ethernetDNS, "ethernetDNS", _IPString, 0,  },
    { 0, 1, 1, & settings.ethernetGateway, "ethernetGateway", _IPString, 0,  },
    { 0, 1, 1, & settings.ethernetSubnet, "ethernetSubnet", _IPString, 0,  },
    { 0, 1, 1, & settings.httpPort, "httpPort", _uint16_t, 0,  },

    { 0, 1, 1, & settings.debugWifiState, "debugWifiState", _bool, 0,  },
    { 0, 0, 1, & settings.wifiConfigOverAP, "wifiConfigOverAP", _bool, 0,  }, // TODO: check drop downs

    { 0, 1, 1, & settings.wifiNetworks, "wifiNetwork_", _wifiNetwork, MAX_WIFI_NETWORKS,  },

    { 0, 1, 1, & settings.defaultNetworkType, "defaultNetworkType", _uint8_t, 0,  },
    { 0, 1, 1, & settings.debugNetworkLayer, "debugNetworkLayer", _bool, 0,  },
    { 0, 1, 1, & settings.enableNetworkFailover, "enableNetworkFailover", _bool, 0,  },
    { 0, 1, 1, & settings.printNetworkStatus, "printNetworkStatus", _bool, 0,  },

    { 0, 1, 1, & settings.mdnsEnable, "mdnsEnable", _bool, 0,  },

    { 0, 1, 1, & settings.debugMqttClientData, "debugMqttClientData", _bool, 0,  },
    { 0, 1, 1, & settings.debugMqttClientState, "debugMqttClientState", _bool, 0,  },

    { 0, 1, 1, & settings.debugNtp, "debugNtp", _bool, 0,  },
    { 0, 1, 1, & settings.ethernetNtpPort, "ethernetNtpPort", _uint16_t, 0,  },
    { 0, 1, 1, & settings.enableNTPFile, "enableNTPFile", _bool, 0,  },
    { 0, 1, 1, & settings.ntpPollExponent, "ntpPollExponent", _uint8_t, 0,  },
    { 0, 1, 1, & settings.ntpPrecision, "ntpPrecision", _int8_t, 0,  },
    { 0, 1, 1, & settings.ntpRootDelay, "ntpRootDelay", _uint32_t, 0,  },
    { 0, 1, 1, & settings.ntpRootDispersion, "ntpRootDispersion", _uint32_t, 0,  },
    { 0, 1, 1, & settings.ntpReferenceId, "ntpReferenceId", _charArray, sizeof(settings.ntpReferenceId),  },

    { 0, 1, 1, & settings.debugNtripClientRtcm, "debugNtripClientRtcm", _bool, 0,  },
    { 0, 1, 1, & settings.debugNtripClientState, "debugNtripClientState", _bool, 0,  },
    { 0, 1, 1, & settings.enableNtripClient, "enableNtripClient", _bool, 0,  },
    { 0, 1, 1, & settings.ntripClient_CasterHost, "ntripClientCasterHost", _charArray, sizeof(settings.ntripClient_CasterHost),  },
    { 0, 1, 1, & settings.ntripClient_CasterPort, "ntripClientCasterPort", _uint16_t, 0,  },
    { 0, 1, 1, & settings.ntripClient_CasterUser, "ntripClientCasterUser", _charArray, sizeof(settings.ntripClient_CasterUser),  },
    { 0, 1, 1, & settings.ntripClient_CasterUserPW, "ntripClientCasterUserPW", _charArray, sizeof(settings.ntripClient_CasterUserPW),  },
    { 0, 1, 1, & settings.ntripClient_MountPoint, "ntripClientMountPoint", _charArray, sizeof(settings.ntripClient_MountPoint),  },
    { 0, 1, 1, & settings.ntripClient_MountPointPW, "ntripClientMountPointPW", _charArray, sizeof(settings.ntripClient_MountPointPW),  },
    { 0, 1, 1, & settings.ntripClient_TransmitGGA, "ntripClientTransmitGGA", _bool, 0,  },

    { 0, 1, 1, & settings.debugNtripServerRtcm, "debugNtripServerRtcm", _bool, 0,  },
    { 0, 1, 1, & settings.debugNtripServerState, "debugNtripServerState", _bool, 0,  },
    { 0, 1, 1, & settings.enableNtripServer, "enableNtripServer", _bool, 0,  },

    { 0, 1, 1, & settings.ntripServer_CasterHost[0], "ntripServerCasterHost_", _ntripServerCasterHost, NTRIP_SERVER_MAX,  },
    { 0, 1, 1, & settings.ntripServer_CasterPort[0], "ntripServerCasterPort_", _ntripServerCasterPort, NTRIP_SERVER_MAX,  },
    { 0, 1, 1, & settings.ntripServer_CasterUser[0], "ntripServerCasterUser_", _ntripServerCasterUser, NTRIP_SERVER_MAX,  },
    { 0, 1, 1, & settings.ntripServer_CasterUserPW[0], "ntripServerCasterUserPW_", _ntripServerCasterUserPW, NTRIP_SERVER_MAX,  },
    { 0, 1, 1, & settings.ntripServer_MountPoint[0], "ntripServerMountPoint_", _ntripServerMountPoint, NTRIP_SERVER_MAX,  },
    { 0, 1, 1, & settings.ntripServer_MountPointPW[0], "ntripServerMountPointPW_", _ntripServerMountPointPW, NTRIP_SERVER_MAX,  },

    { 0, 1, 1, & settings.debugTcpClient, "debugTcpClient", _bool, 0,  },
    { 0, 1, 1, & settings.enableTcpClient, "enableTcpClient", _bool, 0,  },
    { 0, 1, 1, & settings.tcpClientPort, "tcpClientPort", _uint16_t, 0,  },
    { 0, 1, 1, & settings.tcpClientHost, "tcpClientHost", _charArray, sizeof(settings.tcpClientHost),  },

    { 0, 1, 1, & settings.debugTcpServer, "debugTcpServer", _bool, 0,  },
    { 0, 1, 1, & settings.enableTcpServer, "enableTcpServer", _bool, 0,  },
    { 0, 1, 1, & settings.tcpServerPort, "tcpServerPort", _uint16_t, 0,  },

    { 0, 1, 1, & settings.debugUdpServer, "debugUdpServer", _bool, 0,  },
    { 0, 1, 1, & settings.enableUdpServer, "enableUdpServer", _bool, 0,  },
    { 0, 1, 1, & settings.udpServerPort, "udpServerPort", _uint16_t, 0,  },

    { 0, 0, 1, & settings.um980MessageRatesNMEA, "um980MessageRatesNMEA_", _um980MessageRatesNMEA, MAX_UM980_NMEA_MSG,  },
    { 0, 0, 1, & settings.um980MessageRatesRTCMRover, "um980MessageRatesRTCMRover_", _um980MessageRatesRTCMRover, MAX_UM980_RTCM_MSG,  },
    { 0, 0, 1, & settings.um980MessageRatesRTCMBase, "um980MessageRatesRTCMBase_", _um980MessageRatesRTCMBase, MAX_UM980_RTCM_MSG,  },
    { 0, 1, 1, & settings.um980Constellations, "um980Constellations_", _um980Constellations, MAX_UM980_CONSTELLATIONS,  },

    { 0, 1, 1, & settings.enableTiltCompensation, "enableTiltCompensation", _bool, 0,  },
    { 0, 1, 1, & settings.tiltPoleLength, "tiltPoleLength", _float, point3float,  },
    { 0, 1, 1, & settings.enableImuDebug, "enableImuDebug", _bool, 0,  },

    { 0, 1, 1, & settings.debugFirmwareUpdate, "debugFirmwareUpdate", _bool, 0,  },
    { 0, 1, 1, & settings.enableAutoFirmwareUpdate, "enableAutoFirmwareUpdate", _bool, 0,  },
    { 0, 1, 1, & settings.autoFirmwareCheckMinutes, "autoFirmwareCheckMinutes", _uint32_t, 0,  },

    { 0, 1, 1, & settings.debugCorrections, "debugCorrections", _bool, 0,  },
    { 0, 1, 1, & settings.enableCaptivePortal, "enableCaptivePortal", _bool, 0,  },

    { 0, 1, 1, & settings.printBootTimes, "printBootTimes", _bool, 0,  },

    { 0, 1, 1, & settings.printPartitionTable, "printPartitionTable", _bool, 0,  },

    { 0, 1, 1, & settings.measurementScale, "measurementScale", _uint8_t, 0,  },

    { 0, 1, 1, & settings.debugWiFiConfig, "debugWiFiConfig", _bool, 0,  },
    { 0, 1, 1, & settings.enablePsram, "enablePsram", _bool, 0,  },
    { 0, 1, 1, & settings.printTaskStartStop, "printTaskStartStop", _bool, 0,  },
    { 0, 1, 1, & settings.psramMallocLevel, "psramMallocLevel", _uint16_t, 0,  },
    { 0, 1, 1, & settings.enableBeeper, "enableBeeper", _bool, 0,  },
    { 0, 1, 1, & settings.enableImuCompensationDebug, "enableImuCompensationDebug", _bool, 0,  },

    { 0, 1, 1, & settings.correctionsSourcesPriority, "correctionsPriority_", _correctionsSourcesPriority, correctionsSource::CORR_NUM,  },

    { 0, 1, 1, & settings.correctionsSourcesLifetime_s, "correctionsSourcesLifetime", _int, 0,  },

    { 0, 1, 1, & settings.geographicRegion, "geographicRegion", _int, 0,  },

    { 0, 1, 1, & settings.regionalCorrectionTopics, "regionalCorrectionTopics_", _regionalCorrectionTopics, numRegionalAreas,  },

    { 0, 1, 1, & settings.debugEspNow, "debugEspNow", _bool, 0,  },
    { 0, 1, 1, & settings.enableEspNow, "enableEspNow", _bool, 0,  },
    { 0, 1, 1, & settings.wifiChannel, "wifiChannel", _uint8_t, 0,  },
    { 0, 1, 1, & settings.enableGalileoHas, "enableGalileoHas", _bool, 0,  },

    { 0, 1, 1, & settings.enableGnssToUsbSerial, "enableGnssToUsbSerial", _bool, 0,  },
    { 0, 1, 1, & settings.pplFixTimeoutS, "pplFixTimeoutS", _uint16_t, 0,  },

    // Add new settings above <------------------------------------------------------------>
    /*
    { 0, 1, 1, & settings., "", type, 0,  },
    */
};
