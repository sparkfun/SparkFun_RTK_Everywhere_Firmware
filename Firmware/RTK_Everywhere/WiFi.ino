...
bool wifiStart()
{
    ...
    if (networkConsumerBits(NETWORK_WIFI_STATION))
        startWiFiStation = true;

    // The consumers need AP
    if (networkSoftApConsumerBits())
        startWiFiAp = true;
                       ...
                       bool startAP)
{
    ...
    {
        displayWiFiConnect();
        started = enable(wifiEspNowRunning, _softApRunning, true, __FILE__, __LINE__);
    }
...
{
    return wifiEspNowRunning | _softApRunning | _stationRunning;
}
