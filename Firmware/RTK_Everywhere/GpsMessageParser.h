...
#include "crc32.h"  // 32-bit CRC cyclic redundancy checksum for unicore parsing
...
#ifdef  PARSE_UNICORE_MESSAGES
#define UNICORE_PREAMBLE    unicorePreamble,
#else
#define UNICORE_PREAMBLE
#endif  // PARSE_UNICORE_MESSAGES
